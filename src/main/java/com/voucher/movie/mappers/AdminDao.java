...
public interface AdminDao {
	...
	@Insert("insert into reservation_closed (closed_date, setting_status) values (#{setting_date}, 1)")
	...
	@Update("update reservation_closed set setting_status = 0 where closed_date = #{setting_date}")
	...
	@Update("update reservation_time set res_time = #{setting_time}, res_limited = #{limited_num}, time_status = 1 where res_date = #{setting_date} and res_num = #{time_num}")
